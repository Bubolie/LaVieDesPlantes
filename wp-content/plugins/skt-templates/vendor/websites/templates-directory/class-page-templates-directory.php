	...
	class PageTemplatesDirectory {
		...
		public function templates_list() {
			...
			$templates_list = array(
				'skt-hotel-elementor'              => array(
					'title'       => __( 'SKT Hotel', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-hotel/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-hotel/skt-hotel.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-hotel/skt-hotel.json'),
					'keywords'    => __( ' SKT Hotel, skt hotel, Motels, accommodation, Motel accommodation, Hostels, backpackers , Apartments, Bed & Breakfasts, Holiday Homes, Homestays, Holiday Parks, Campgrounds, Farm stays, Luxury Lodges, Boutiques, Lodges, houses, pavilions, stays, gatehouse, hall, club, reside, rent rooms, inhabits, cottage, retreat, main building, clubhouse, hostelry, stays, lodging, pubs, traveler, service, hospices, room, hoteles, guests, facilities, hotel staff, location, hospitality, hotel management, catering, hostelries, roadhouses, bars, resort, canal, innkeeper, hotel accommodation, reservations, hotel business, place, in hotels, settlements, schools, establishments, institutions, properties, farmhouses, hotel, Hotel', 'skt-templates' ),
				),
				...
				'free-sktwhite-elementor'              => array(
					...
					'keywords'    => __( ' SKT White, skt white, corporate, business, consulting, agency, people, meeting, communal, working, workforce, office, accounting, lawyer, coaching, advocate, advice, suggestion, therapy, mental wellness, White, white, clean' ),
				),
				'sktsushi-elementor'              => array(
					'title'       => __( 'SKT Sushi', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/sushi/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/sushi/skt-sushi.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/sushi/skt-sushi.json'),
					'keywords'    => __( ' sushi, Sushi, appointment, book a table, cafe, cuisine, delivery food, dining, events, food, menu, reservation, responsive, restaurant, sushi, asian food, bakery, bar, cafe, cafeteria, chef, coffee shop, cooking business, elementor, organic, pizza, bistro, delivery, food menu, restaurant menu, rosa, sushi restaurant, thai food', 'skt-templates' ),
				),
				'sktrestara-elementor'              => array(
					'title'       => __( 'SKT Restara', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/restara/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/restara/skt-restara.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/restara/skt-restara.json'),
					'keywords'    => __( ' restara, Restara, eatery, eating house, bistro, cafeteria, grill, brasserie, steakhouse, hotel, dining hall, bar, catering, dining, food, café, canteen, pizzeria, snack bar, place, restaurant, cattleman, restaurant, hostelry, guests, lunch counter, chophouse, dining room, drink, luncheonette, drink, eating, food service, dining facilities, beverage services, meal service, breakfast, buffet, food counter, hotels, breakfast, dinner, lunch', 'skt-templates' ),
				),
				'sktphysiotherapy-elementor'              => array(
					'title'       => __( 'SKT Physiotherapy', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/physiotherapy/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/physiotherapy/skt-physiotherapy.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/physiotherapy/skt-physiotherapy.json'),
					'keywords'    => __( ' physiotherapy, Physiotherapy, Therapy clinics, Rehabilitation, Rehab therapy, Exercise, Movement therapy, Manual therapy, Physio, Rehabilitation, medicine, Injury Prevention, Chiropractic Therapy, Massage Therapy, Sports injuries, Clinical Pilates, clinic, doctor, health, hospital, medical, medicine, physiotherapy, treatment', 'skt-templates' ),
				),
				'sktpizzeria-elementor'              => array(
					'title'       => __( 'SKT Pizzeria', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/pizzeria/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/pizzeria/skt-pizzeria.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/pizzeria/skt-pizzeria.json'),
					'keywords'    => __( ' pizzeria, Pizzeria, barbeque, burger, candy, candy store, cooking, diner, fast food, food, food shop, Italian Cuisine, Mexican Food, pizza, snack, sweet, sweet shop, Fast Food Chain, Burger Shops, Bakery, Street Food, Food Truck, Sushi Bar, burger, food delivery, pizza', 'skt-templates' ),
				),
				'sktcoach-elementor'              => array(
					'title'       => __( 'SKT Coach', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-coach/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-coach/skt-coach.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-coach/skt-coach.json'),
					'keywords'    => __( ' sktcoach, SKT Coach, business coach, business consulting, business planner, career counseling, coaching, health coach, life coach, marriage counseling, mentor, personal trainer, psychologist, therapist, therapy, training, coaching, dietitian, fitness, health coach, healthy living, holistic, life coach, lifestyle, mentor, nutrition, shop, trainer, wellness, yoga', 'skt-templates' ),
				),
				'sktglass-elementor'              => array(
					'title'       => __( 'SKT Glass', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-glass/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-glass/skt-glass.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-glass/skt-glass.json'),
					'keywords'    => __( ' sktglass, SKT Glass, Glaziers, glass doors, glass furniture, glass, interior design, metal, plastic windows, upvc, window glass, window systems, windows, fiberglass, windshield, Car glass, car glass repair, truck glass, Windshield Installation, chip repair auto glass replacement cost, windshield replacement cost, auto glass chip repair, windshield glass repair, auto glass, mobile auto glass, mobile auto glass repair, auto glass prices, auto glass windshield, auto glass replacement, auto window glass, ppg auto glass, auto glass replacement quote, cheap auto glass', 'skt-templates' ),
				),
				'sktgolf-elementor'              => array(
					'title'       => __( 'SKT Golf', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-golf/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-golf/skt-golf.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-golf/skt-golf.json'),
					'keywords'    => __( ' sktgolf, SKT Golf, golf, golf club, golf course, golf resort, golf theme, golfing, resorts, sport club, tournament, athlete, clubhouse, coach, country club, driving range, luxury, mini golf, pro shop, sport pro, sports, trainer', 'skt-templates' ),
				),
				'skttrekking-elementor'              => array(
					'title'       => __( 'SKT Trekking', 'skt-templates' ),
					'description' => __( 'It downloads from our website sktthemes.org, once you do it you will get the exact preview like shown in the demo. Steps after downloading the theme: Upload it via appearance>themes>add new>upload theme zip file and activate the theme.', 'skt-templates' ),
					'theme_url'   => esc_url('#'),
					'demo_url'    => esc_url('https://demosktthemes.com/free/skt-trekking/'),
					'screenshot'  => esc_url('https://demosktthemes.com/free/skt-trekking/skt-trekking.jpg'),
					'import_file' => esc_url('https://demosktthemes.com/free/skt-trekking/skt-trekking.json'),
					'keywords'    => __( ' trekking, SKT Trekking, dive, diving, diving courses, hike, holidays, sail, sailing, sailing courses, summer activities, tours, adventure, fashion, fitness, sport, tent, travel, trekking, camping, hiking, trek, mountain climbing, trails, adventure sports, bouldering, explorer, expedition, survival, outdoor activities, campsite, glamping, campground, camping village, camp, camper, trails, survival training, expedition, travel package, travel backpacking', 'skt-templates' ),
				),
